...
bool isValid() {
    ...
    while(!q.empty()){
        ...
        for(int d=0;d<4;d++){
            ...
            if(next_column >= 0 && next_column < 5 && next_row >= 0 && next_row < 5) {
                if(visited[next_row][next_column] == 0) {
                    if(chosen[next_row * 5 + next_column] == true) {
